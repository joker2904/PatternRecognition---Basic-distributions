...
# Function to plot points using Matplotlib . This is initially provided to us
...
class FitWeibull:
    ...
    # Iteration to implement Newton Raphson method
    # Computes the hessian and gradient matrix at every iteration step
    # Multiplication of the inverse of hessian matrix and the gradient matrix is doneand added to the current values of
    # Alpha and Beta ( shape and scale parameters ) to get new parameters.
    # As per the requirement, 20 iterations are completed and process is stopped to get the alpha and beta
...
print("\n Obtained by Iterative procedure ( a,k ) = ", a, k)
