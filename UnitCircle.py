...
# Function to plot the points, it was provided to us initially
...
if __name__ == "__main__":
    ...
    # Consider the Lp norm for p and plot the corresponding  unit circle
    # Using contour ( x-y plane , z = 0) This is the point where euclidean distance  = 1
    ...
    # Call the Function to plot unit circle, with p = 0.5
    plotUnitCircle(0.5)